...
// Define valid venue keys
type VenueSlug = "pub" | "cocktail-bar" | "private-hire";
...
export default function MenuSection({
  ...
  const rawSlug = pathname?.startsWith("/venues")
    ? pathname.split("/")[2]
    : "default";

  // Ensure TypeScript knows slug is a valid key or fallback
  const venueSlug: VenueSlug | "default" =
    (rawSlug as VenueSlug) in venueStyles ? (rawSlug as VenueSlug) : "default";

  const currentStyles = venueStyles[venueSlug];
